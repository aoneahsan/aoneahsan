...
| Repository | https://github.com/aoneahsan/aoneahsan (special profile repo) |
| Type | GitHub `username/username` profile repo (renders on profile landing) |
| License | MIT |
...
### Top 20
#GitHubProfile #DeveloperProfile #FullStackDeveloper #SaaSSpecialist #BuildInPublic #GitHub #DeveloperBranding #PersonalBrand #ProfileReadme #AhsanMahmood #aoneahsan #Zaions #SoftwareDeveloper #ProductEngineering #IndieDev #TechPortfolio #Recruiting #DeveloperJourney #OpenSource #BannerDesign
...
Refresh weekly (MANDATORY); 3-day skip floor; max 10 history records. Filename always carries last-updated date. Final destination: `~/Documents/ahsan-notebook/static/assets/personal/projects-info-as-portfolio-item/apps/GITHUB-PROFILE_portfolio-info_<YYYY-MM-DD>.md`.
